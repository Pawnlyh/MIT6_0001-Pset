...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for letter in lowercase:
            shift_letter = lowercase[(string.ascii_lowercase.find(letter, 0) + shift) % 26]
    ...
    def apply_shift(self, shift):
        ...
        for i in range(len(message_list)):
            if message_list[i].isalpha():
                message_list[i] = shift_dict[message_list[i]]
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        for i in range(27):
            word_shifted = self.apply_shift(i)
            word_list = word_shifted.split()
            ...
            for word in word_list:
                if is_word(valid_words, word):
                    ...
                    break
            # if flag == len(word_list):
            if flag > 0:
                break
        return i, word_shifted
...
if __name__ == '__main__':
    ...
    story_text = CiphertextMessage(story_string)
    print(story_string)
    print('Actual story: ', story_text.decrypt_message())
